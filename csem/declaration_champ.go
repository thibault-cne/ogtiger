...
func (l *SemControlListener) DeclarationChampEnter(ctx parser.IDeclarationChampContext) {
	// Nothing to do
}

func (l *SemControlListener) DeclarationChampExit(ctx parser.IDeclarationChampContext) {
