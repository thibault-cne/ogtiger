...
func (l *SemControlListener) DeclarationArrayTypeEnter(ctx parser.DeclarationArrayTypeContext) {
	// l.AstStack = append(l.AstStack, &Expr{})
}

func (l *SemControlListener) DeclarationArrayTypeExit(ctx parser.DeclarationArrayTypeContext) {
