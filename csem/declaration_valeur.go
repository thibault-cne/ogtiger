...
func (l *SemControlListener) DeclarationValeurEnter(ctx parser.IDeclarationValeurContext) {
	// Nothing to do
}

func (l *SemControlListener) DeclarationValeurExit(ctx parser.IDeclarationValeurContext) {
