...
func (l *SemControlListener) DeclarationRecordTypeEnter(ctx parser.DeclarationRecordTypeContext) {
	// l.AstStack = append(l.AstStack, &Expr{})
}

func (l *SemControlListener) DeclarationRecordTypeExit(ctx parser.DeclarationRecordTypeContext) {
