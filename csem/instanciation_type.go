...
func (l *SemControlListener) InstanciationTypeEnter(ctx parser.InstanciationTypeContext) {
	// Nothing to do
}

func (l *SemControlListener) InstanciationTypeExit(ctx parser.InstanciationTypeContext) {
