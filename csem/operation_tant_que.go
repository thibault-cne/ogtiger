...
func (l *SemControlListener) OperationTantQueEnter(ctx parser.IOperationTantqueContext) {
	// Create a new region
	l.Slt = l.Slt.CreateRegion()
}

func (l *SemControlListener) OperationTantQueExit(ctx parser.IOperationTantqueContext) {
	oT := &OperationTantQue{
		Ctx:  ctx,
