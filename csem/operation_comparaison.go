...
func (l *SemControlListener) OperationComparaisonEnter(ctx parser.IOperationComparaisonContext) {
	// l.AstStack = append(l.AstStack, &Expr{})
}

func (l *SemControlListener) OperationComparaisonExit(ctx parser.IOperationComparaisonContext) {
